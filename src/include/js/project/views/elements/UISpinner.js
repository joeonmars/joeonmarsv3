...
joeonmars.views.elements.UISpinner = function(radius, color, progress) {
  goog.base(this);
...
joeonmars.views.elements.UISpinner.prototype.setColor = function(color) {
  this.color = color;
  goog.style.setStyle(this.loader, 'fill', color);
};


joeonmars.views.elements.UISpinner.prototype.setProgress = function(prog) {
  this.progress = prog;
  this.draw();
};


joeonmars.views.elements.UISpinner.prototype.setSize = function(radius) {
  this.radius = radius;
  this.diameter = this.radius * 2;
...
joeonmars.views.elements.UISpinner.prototype.draw = function() {
