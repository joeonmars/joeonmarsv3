...
os.system( "rm -r " + deploy_path + '.htaccess' )
...
os.system( "rm -r " + deploy_path + 'assets/images/animation/source' )

print 'Compiling index.php...'
os.system( "php " + deploy_path + 'index.php > ' + deploy_path + 'index.html' )
os.system( "php " + deploy_path + 'index.php local > ' + deploy_path + 'index-local.html' )
os.system( "php " + deploy_path + 'index.php cdn > ' + deploy_path + 'index-cdn.html' )
os.system( "php " + deploy_path + 'index.php flash > ' + deploy_path + 'index-flash.html' )
os.system( "rm " + deploy_path + 'index.php' )
...
if len(third_party_files) > 0 and useExterns:
	...
	#	file_name = item_path.replace('../../src/include/js/libs/third-party/', '', 1)
	#	print file_name
	#	shutil.copyfile(item_path, deploy_path + 'assets/js/libs/' + file_name);

shutil.copyfile(src_path + 'favicon.ico', deploy_path + 'favicon.ico');
shutil.copyfile(src_path + 'panorama.html', deploy_path + 'panorama.html');

if deploy:
	print 'Moving htaccess files.'
	shutil.copyfile('.htaccess', deploy_path + '.htaccess');
	shutil.copyfile('.htpasswd', deploy_path + '.htpasswd');
